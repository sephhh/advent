...
function findLeadReindeer(time, reindeers){
    var maxDist = 0;
    var leadReindeer = null;
    for (key in reindeers){
        // debugger;
        var reindeerDist = reindeers[key].totalDistance(time);
...
for (var i = 1; i <= 2503; i++) {
    var leadReindeerName = findLeadReindeer(i, reindeers);
    reindeers[leadReindeerName].totalPoints += 1;
}
